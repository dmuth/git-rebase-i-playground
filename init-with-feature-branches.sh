...
echo "# Creating braches..."
git checkout -b $BRANCH1 >/dev/null 2>/dev/null
commit 10-branch1
git push --set-upstream origin feature-branch-1 >/dev/null 2>/dev/null
git checkout main >/dev/null 2>/dev/null

git checkout -b $BRANCH2 >/dev/null 2>/dev/null
commit 20-branch2
git push --set-upstream origin feature-branch-2 >/dev/null 2>/dev/null
git checkout main >/dev/null 2>/dev/null

git checkout -b $BRANCH3 >/dev/null 2>/dev/null
commit 30-branch3
git push --set-upstream origin feature-branch-3 >/dev/null 2>/dev/null
git checkout main >/dev/null 2>/dev/null
